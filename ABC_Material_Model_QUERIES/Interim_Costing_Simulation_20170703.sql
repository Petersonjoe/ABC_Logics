...
--BEGIN TRANSACTION
--GO
--EXECUTE sp_rename N'staging.ABC_INTERIM_COSTING_SIMULATION.[Interim Con Cost]', N'Tmp_Interim Cons Cost_1', 'COLUMN' 
--GO
--EXECUTE sp_rename N'staging.ABC_INTERIM_COSTING_SIMULATION.[Tmp_Interim Cons Cost_1]', N'Interim Cons Cost', 'COLUMN' 
--GO
--ALTER TABLE staging.ABC_INTERIM_COSTING_SIMULATION SET (LOCK_ESCALATION = TABLE)
--GO
--COMMIT
...
FROM staging.ABC_INTERIM_COSTING_SIMULATION AA
